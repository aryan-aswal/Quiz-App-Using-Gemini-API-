...
import { GoogleAIFileManager, getUploadMetadata } from "@google/generative-ai/src/server/file-manager";
import * as sinonChai from "sinon-chai";
import * as chaiAsPromised from "chai-as-promised";
import { restore, stub } from "sinon";
import * as request from "@google/generative-ai/src/server/request";
import { RpcTask } from "@google/generative-ai/src/server/constants";
import { DEFAULT_API_VERSION } from "@google/generative-ai/src/requests/request";
import { FileMetadata } from "@google/generative-ai/types/server";
